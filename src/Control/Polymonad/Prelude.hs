...
-- | A replacement of the standard "Prelude" for polymonads. Should provide
--   all of the functions also provided in the original prelode without
--   the functions related specifically to 'P.Monad's. The functions related
--   to 'P.Monad's are replaced with their 'Polymonad' counterparts.
--
--   A replacement for the functions in "Control.Monad" can be found in "Control.Polymonad.Functions".
module Control.Polymonad.Prelude
  ( -- * Prelude
